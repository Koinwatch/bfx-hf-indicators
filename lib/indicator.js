...
class Indicator {
  ...
  add (v) {
    this._values.push(v)
    // REDUCE LENGTH OF ARRAY TO SEED PERIOD PLUS 20  
    if(this._values.length > (this._seedPeriod+20)) {
        this._values = this._values.slice((0-(this._seedPeriod+20)),this._values.length)
    }    
    return v
  }
